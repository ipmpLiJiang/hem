$(function(){
	...
	var tableDiv4 = "<span class='tableSq'><a href='STAFF_NURSE_MEMBER.aspx'>家庭成员及社会关系</a></span>";
	var tableDiv5 = "<span class='tableSq'><a href='STAFF_NURSE_REWARD.aspx'>获奖情况</a></span>";
	var tableDiv6 = "<span class='tableSq' style='display:none;'><a href='STAFF_NURSE_FILEUPLOAD.aspx'>简历上传</a></span>";
	
	$(".tableL").append(tableDiv1).append(tableDiv2).append(tableDiv3).append(tableDiv4).append(tableDiv5).append(tableDiv6);
