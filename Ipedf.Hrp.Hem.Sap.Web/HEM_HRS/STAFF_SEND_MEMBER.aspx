<%@ Page Language="C#" MasterPageFile="~/Controls/User.Master" AutoEventWireup="true" CodeBehind="STAFF_SEND_MEMBER.aspx.cs" Inherits="Ipedf.Hrp.Hem.Sap.Web.STAFF_SEND_MEMBER" Title="家庭成员及社会关系" %>
...
<div class="col-md-10 col-sm-9 loginRight" id="rightBg">
	<div class="row titleTable">
		<div class="tableL tabelList">
			<h4><a class="atip" href="<%=ResolveClientUrl("~/HEM_HRS/STAFF_SEND_BASIC.aspx") %>">派遣基本信息</a></h4>
		</div>
		<div class="tableR">
